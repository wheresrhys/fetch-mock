...
!(function() {
	...
	(t.version = '0.7.1'),
		...
		(t.Index.prototype.search = function(e) {
			let n = this.pipeline.run(this.tokenizerFn(e)),
				i = new t.Vector(),
				r = [],
			...
			n.forEach(function(e, n, s) {
				let a = (1 / s.length) * this._fields.length * o,
					h = this,
					u = this.tokenStore.expand(e).reduce(function(n, r) {
						let o = h.corpusTokens.indexOf(r),
							s = h.idf(r),
							u = 1,
							l = new t.SortedSet();
						if (r !== e) {
