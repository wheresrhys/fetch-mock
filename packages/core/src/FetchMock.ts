...
import * as requestUtils from './RequestUtils.ts';
...
const defineShorthand = (shorthandOptions: UserRouteConfig) => {
  return function (matcher: RouteMatcher | UserRouteConfig, response?: RouteResponse, options?: UserRouteConfig | string) {
    return this.route(
      matcher,
      response,
...
const defineGreedyShorthand = (shorthandOptions: UserRouteConfig) => {
  return function (response: RouteResponse, options?: UserRouteConfig | string) {
    return this.route(
      '*',
      response,
      Object.assign(options || {}, shorthandOptions),
