...
describe('url matching', () => {
	...
	it('match begin: keyword', async () => {
		const route = new Route({matcher: 'begin:http://a.com/path', response:200});
	...
	describe('data: URLs', () => {
		it('match exact strings', async () => {
			const route = new Route({matcher: 'data:text/plain,path', response:200});
		...
		it('match begin: keyword', async () => {
			const route = new Route({matcher: 'begin:data:text/plain', response:200});
