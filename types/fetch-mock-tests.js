...
fetchMock.mock(function () { return true; }, 200);
fetchMock.mock(function (url, opts) { return true; }, 200);
...
fetchMock.mock({
    ...
    repeat: 1,
    delay: 500,
    functionMatcher: function () { return true; }
});
fetchMock.mock({
    url: "http://test.com"
}, 200);
fetchMock.restore().reset().resetHistory().resetBehavior();
var calls = fetchMock.calls(/https?:\/\/test.com/, {
    method: 'GET'
});
...
var lastOptions = fetchMock.lastOptions();
...
var lastResponse = fetchMock.lastResponse();
...
fetchMock
    .mock("http://test.com", 200)["catch"](503);
fetchMock
    .mock("http://test.com", 200)
    .spy();
var myMatcher = function (url, opts) { return true; };
fetchMock.flush().then(function (resolved) { return resolved.forEach(console.log); });
fetchMock.flush()["catch"](function (r) { return r; });
fetchMock.flush(true)["catch"](function (r) { return r; });
...
var sandbox = fetchMock.sandbox();
sandbox.get("http://test.com", {
    body: 'abc',
    redirectUrl: "http://example.org"
});
var stickySandbox = fetchMock.sandbox();
...
fetchMock.config.fetch = function () { return new Promise(function () { }); };
